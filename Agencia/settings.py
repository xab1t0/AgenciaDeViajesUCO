...
SECRET_KEY = 'vlplk8ui)!a_-7gfei$1s%y5e4#17dqljrskkkevz1)7=jkbgq'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'Agencia/templates/Agencia/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'Agencia/media')
MEDIA_URL = '/media/'
